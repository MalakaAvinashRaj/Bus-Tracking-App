import 'dart:async';
import 'package:email_password_login/login/registration_screen.dart';
...
import 'package:email_password_login/screens/login/otp_screen.dart';
                  ...
                  if (user.emailVerified)
                    {
                      ...
                      Navigator.of(context).pushReplacementNamed(blackTintRoute)
                    }
                  else
                    {
                      Navigator.of(context).pop,
